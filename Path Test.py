...
if __name__ == '__main__':
    try:
        ...
        set_param(cf, 'ctrlMel', 'ki_z', 0.07) #Default: 0.05
        set_param(cf, 'ctrlMel', 'i_range_z', 10.0) #Default: 2.0
        ...
        set_param(cf, 'ctrlMel', 'kw_z', 8500) #Default: 8000
        ...
        # PICKLE ###################################################################################
        directory = ("Experiments/Point Experiment-"+time.asctime(time.localtime())).replace(":", "-")
        os.mkdir(directory)
        ...
        # PAPER FIGURE ##################################################################################
        figure, ax4 = plt.subplots(nrows= 2, ncols=1, figsize=(6,5), sharex="col")
